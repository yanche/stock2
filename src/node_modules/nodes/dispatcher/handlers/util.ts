...
export function genGetOneHandler(colc: utility.mongo.CollClient) {
...
export function genGetMulHandler(colc: utility.mongo.CollClient) {
    return (hpack: utility.http.HttpPack) => bb.resolve().then(() => {
        const body = hpack.reqbody;
...
export function genGetAllHandler(colc: utility.mongo.CollClient) {
    return (hpack: utility.http.HttpPack) => bb.resolve().then(() => {
        const body = hpack.reqbody;
...
export function genCreateOneHandler(colc: utility.mongo.CollClient, modelgen: (body: any) => HandlerDataModel) {
    return (hpack: utility.http.HttpPack) => bb.resolve().then(() => {
...
export function genCreateMulHandler(colc: utility.mongo.CollClient, modelgen: (body: any) => HandlerDataModel) {
    return (hpack: utility.http.HttpPack) => bb.resolve().then(() => {
        const body = hpack.reqbody;
        if (!Array.isArray(body) || body.list.length === 0) {
...
export function genRemoveAllHandler(colc: utility.mongo.CollClient) {
    return (hpack: utility.http.HttpPack) => bb.resolve().then(() => {
...
export function genUpdateAllHandler(colc: utility.mongo.CollClient, upsert: boolean) {
    return (hpack: utility.http.HttpPack) => bb.resolve().then(() => {
        const body = hpack.reqbody;
...
export function genBulkUpdateHandler(colc: utility.mongo.CollClient, upsert: boolean) {
    return (hpack: utility.http.HttpPack) => bb.resolve().then(() => {
        const body = hpack.reqbody;
