...
class SimulateCreateModel implements hutil.HandlerDataModel {
    ...
    constructor(httpbody: d.Simulate) {
        ...
        this._valid = utility.validate.nonEmptyStr(this._mongodoc.target) && utility.validate.isBool(this._mongodoc.closed) && utility.validate.isBool(this._mongodoc.glong)
            && utility.validate.nonEmptyStr(this._mongodoc.rtplanId) && Array.isArray(this._mongodoc.env) && Array.isArray(this._mongodoc.concernsIn) && Array.isArray(this._mongodoc.concernsOut)
