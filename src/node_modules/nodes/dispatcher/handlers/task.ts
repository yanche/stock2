...
function handler(h: utility.http.HttpPack) {
...
class TaskCreateModel implements hutil.HandlerDataModel {
    ...
    private _mongodoc: any;

    valid(): boolean { return this._valid; }
    toMongoDoc(): any { return this._mongodoc; }
    constructor(httpbody: any) {
        this._mongodoc = {
        ...
        this._valid = condition.validate(this._mongodoc.condition) && action.validate(this._mongodoc.action)
