...
export function upload(buffer: Buffer, filename: string, dirname: string, container: string): bb<c.FileStorage> {
            ...
            .then(afs => {
                ...
                afs.createBlockBlobFromText(container, blobname, buffer, err => {
                    if (err)
                        ...
                        res({ path: blobname, container: container, storage: 'azure' });
                });
            });
    });
};
