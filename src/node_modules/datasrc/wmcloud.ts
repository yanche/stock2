...
function genWMAPIUrl(category: string, subcat: string, input: Array<{ name: string, val: Array<string> | string }>): string {
    ...
    for (const x of input) {
        ...
        if (Array.isArray(v)) {
            if (v != null && v.length > 0) qry.push(`${n}=${v.join(',')}`);
        }
        else {
...
class GetMktEqudParams extends WMAPIParams {
    constructor(secID: Array<string>, ticker: Array<string>, tradeDate: Date, beginDate: Date, endDate: Date, isOpen: boolean, field: Array<string>) {
        super();
        this._url = genWMAPIUrl('market', 'getMktEqud', [
            {
                ...
                name: 'tradeDate',
                val: utility.date.dateFormat(tradeDate, dateformat, true)
            }, {
                name: 'beginDate',
...
class GetMktIdxdParams extends WMAPIParams {
    constructor(indexID: Array<string>, ticker: Array<string>, tradeDate: Date, beginDate: Date, endDate: Date, field: Array<string>) {
        super();
