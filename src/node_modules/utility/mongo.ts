...
export class CollClient {
    ...
    getOne(filter: Object, fields?: Object): bb<Object> {
        return this._colhub.get()
            .then(col => new bb<Object>((res, rej) => {
                col.findOne(filter, { fields: fields || this._deffields }, (err: Error, doc: Object) => {
                    if (err != null) rej(err);
                    else res(doc);
                })
            }));
    }
    getAll(filter: Object, fields?: Object, orderby?: Object): bb<Array<Object>> {
        return this._colhub.get()
            .then(col => new bb<Array<Object>>((res, rej) => {
                var cursor = col.find(filter, fields || this._deffields);
                if (orderby != null) cursor = cursor.sort(orderby);
                cursor.toArray((err: Error, docs: Array<Object>) => {
                    if (err != null) rej(err);
                    else res(docs);
                })
            }));
    }
    getMul(filter: Object, fields: Object, orderby: Object, skip: number, take: number): bb<Array<Object>> {
        return this._colhub.get()
            .then(col => new bb<Array<Object>>((res, rej) => {
                var cursor = col.find(filter, fields || this._deffields);
                if (orderby != null) cursor = cursor.sort(orderby);
                cursor.limit(take + skip).skip(skip).limit(take).toArray((err: Error, docs: Array<Object>) => {
                    if (err != null) rej(err);
                    else res(docs);
                })
            }));
    ...
    findAndModify(filter: Object, update: Object, fields: Object, returnnew: boolean, upsert: boolean): bb<Object> {
        return this._colhub.get()
            .then(col => new bb<Object>((res, rej) => {
