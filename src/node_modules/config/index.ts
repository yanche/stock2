...
const azurestorage = {
    ...
    container: { static: 'static', raw: 'raw', temp: 'temp', profile: 'profile', lhb: 'lhb', simconcern: 'simconcern' }
}

const localStoragePath = 'D:\\stock temp';

const useFiddler = true;
...
export {useLocalRaw, rawDataFolder, azurestorage, useFiddler, localStoragePath, rawDataExpiryInMS, maintainIdx, maxRawDataCached}
