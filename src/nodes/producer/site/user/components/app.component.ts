...
@Component({
  ...
  providers: [LogService, StockListService, UtilityService, UrlService, ConstService, RtplanService, RtprogService, RtprogoutService, RtpriceService, RequestService, StorageProxyService]
})
